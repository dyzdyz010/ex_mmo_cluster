...
- `docs/current_status/design/voxel/README.md`: 当前事实文档中的 tile 预算口径。
- `docs/current_status/design/client/streaming-lod.md`: Voxia 当前 `SubscribeRadius=3 chunks` 近场事实。
