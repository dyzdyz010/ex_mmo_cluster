...
- **authority coverage 后台流送与 renderer Tile 交接已经分层闭合。** 首次 presentation proof 后 session readiness
  ...
  active-near presentation candidate。
...
[Far LOD 材质语义修复 §11](../../../10-active/voxel-far-field/2026-07-23-far-lod-surface-material-semantic-repair.md)。
...
| 入口 | 当前结果 |
|---|---|
| `VoxiaEditor Win64 Development` | 327 actions，build success，stderr 为空 |
| `Automation RunTests Voxia` | `151/151`，0 failed，0 not-run，exit 0 |
| Node runner/governance | `83/83` pass |
