...
| WorldGen v1 地形算法 | [`docs/10-active/voxel-authority/2026-06-30-worldgen-v1-deterministic-terrain-design.md`](../10-active/voxel-authority/2026-06-30-worldgen-v1-deterministic-terrain-design.md) | Phase 1 确定性地形算法输入；2.5D 高度场 + 材料分层 + 稀疏矿脉 replacement；洞穴/水体走 genesis D-delta |
