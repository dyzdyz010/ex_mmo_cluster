...
| Voxia Far LOD 表面材质语义修复 | [`docs/10-active/voxel-far-field/2026-07-23-far-lod-surface-material-semantic-repair.md`](../10-active/voxel-far-field/2026-07-23-far-lod-surface-material-semantic-repair.md) | 已完成；VXP5 exact surface coverage reducer、live owner/ring/LOD/material receipt、旧产物拒绝、全量/Null-RHI/固定相机 D3D12 与严格审查证据 |
