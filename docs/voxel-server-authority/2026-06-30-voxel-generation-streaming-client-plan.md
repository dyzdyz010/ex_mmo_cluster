...
- `docs/current_status/impl/2026-06-29-world-pack-streaming-handoff.md`
...
- `docs/voxel-server-authority/2026-06-30-worldgen-v1-deterministic-terrain-design.md`
...
- `.demo/observe/` 产物规范
- `docs/current_status/impl/known_gaps.md`

**验收**

- 每级窗口都有可复现命令和 observe JSON。
- 343 chunk 稳定后才允许扩到更大窗口。
- 完成阶段时更新 `docs/current_status/**`，把实现状态和剩余缺口同步成当前事实。
