...
| VLOD-A4 | 体素 LOD **里程碑 A 收尾**:跨 depth 覆盖性 seam + 换环 fade + L1 collar(3.5m) ＋ A5 顶点瘦身/cache LRU ＋ A 验收长巡航 | 决策稿就绪(2026-07-07);战略约束 **FPS=像素-bound**(A4/A5 收几何/显存/视觉正确性、不动 FPS,Lumen 才是 FPS 杠杆);**尚未开工** | [`phase-vlod-a4-seam-fade-collar.md`](./phase-vlod-a4-seam-fade-collar.md) |
