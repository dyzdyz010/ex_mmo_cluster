...
> 基线规范:[`docs/HEMIFUTURE-MMO-架构设计规范-v2.0.1-冻结稿.md`](../HEMIFUTURE-MMO-架构设计规范-v2.0.1-冻结稿.md)。
> 当前事实入口:[`docs/current_status/design/voxel/README.md`](../current_status/design/voxel/README.md)、[`docs/current_status/impl/2026-06-29-world-pack-streaming-handoff.md`](../current_status/impl/2026-06-29-world-pack-streaming-handoff.md)。
...
证据来自 [`2026-06-29-world-pack-streaming-handoff.md`](../current_status/impl/2026-06-29-world-pack-streaming-handoff.md) pressure test:
...
- [`docs/current_status/design/voxel/README.md`](../current_status/design/voxel/README.md) — 体素真值、基线与运行时 diff 当前事实
- [`docs/current_status/impl/2026-06-29-world-pack-streaming-handoff.md`](../current_status/impl/2026-06-29-world-pack-streaming-handoff.md) — world-pack/streaming 当前交接（含 71TB pressure test 反证）
- [`docs/current_status/impl/known_gaps.md`](../current_status/impl/known_gaps.md) — 已知缺口
- [`docs/voxel-server-authority/README.md`](./README.md) — 体素权威化实施跟踪
- [`docs/voxel-server-authority/2026-06-14-architecture-triage-and-alignment.md`](./2026-06-14-architecture-triage-and-alignment.md) — 架构分诊与对齐主线
...
- [`docs/plans/2026-06-28-voxel-tile-budget-runtime-diff-decision.md`](../plans/2026-06-28-voxel-tile-budget-runtime-diff-decision.md) — tile 预算口径
- [`docs/2026-06-25-voxel-world-production-architecture.md`](../2026-06-25-voxel-world-production-architecture.md) — region/world/streaming 目标架构
