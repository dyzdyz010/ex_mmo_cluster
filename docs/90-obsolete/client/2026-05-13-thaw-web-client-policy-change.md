...
status: obsolete
subsystem: client
superseded_by: 90-obsolete/client/2026-06-15-bevy-client-mainline-architecture.md
obsoleted_on: 2026-07-08
---

> ⚠️ **本文已失效** — 本文档把 web_client 定为体素权威化主线 Phase1/2/3/5 的验收口径、bevy_client 降为参考实现；该决策被 2026-06-15《bevy 客户端转主线》决策稿逐条显式撤销（"撤销 2026-05-13「解冻 web_client」决策...方向反转"），是被明确推翻的策略文档。 现行事实见 [`2026-06-15-bevy-client-mainline-architecture.md`](2026-06-15-bevy-client-mainline-architecture.md)。
