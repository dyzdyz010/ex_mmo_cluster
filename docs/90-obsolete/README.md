...
**被推翻 / 反转 / 废弃 / 实验冻结后弃用**的文档。⚠️ **不要作为现行依据**——保留仅为追溯"曾经的决策与为什么被推翻"。每篇顶部有失效横幅 + `superseded_by` 指向现行文档。
...
- [`2026-05-13-thaw-web-client-policy-change.md`](client/2026-05-13-thaw-web-client-policy-change.md)
- [`2026-06-15-bevy-client-mainline-architecture.md`](client/2026-06-15-bevy-client-mainline-architecture.md)

### field-emergence

- [`2026-05-13-体素局部场最小目标-索引.md`](field-emergence/2026-05-13-体素局部场最小目标-索引.md)

### infra

- [`2026-04-17-场景空间索引架构设计.md`](infra/2026-04-17-场景空间索引架构设计.md)
