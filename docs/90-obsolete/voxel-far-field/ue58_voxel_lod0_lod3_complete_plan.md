...
> ⚠️ **本文已失效** — docs/docs/30-reference/overview/2026-07-05-voxia-voxel-lod-production-route.md 证据源列表明确标注本文档为"外部方案 v2，仅参考"，实际生产架构已由 2026-07-05 路线与 2026-07-06 分层设计稿取代。 现行事实见 [`2026-07-06-voxia-lod-layering-and-technology-design.md`](../../30-reference/overview/2026-07-06-voxia-lod-layering-and-technology-design.md)。
