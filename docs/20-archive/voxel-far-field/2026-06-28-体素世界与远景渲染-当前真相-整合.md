...
# 体素世界与远景渲染 · 2026-06-28 整合快照

> ✅ **本文已归档**：它只保留 2026-06-28 的 heightmap/近场联调证据，不再是“当前真相”入口。现行 Voxia 流送与 LOD 状态见 [`streaming-lod.md`](../../00-current-truth/design/client/streaming-lod.md)。

> **历史原文说明**：下列正文保留当时口径，其中 2.5D heightmap/VHI、旧窗口规模与“当前”字样均按 2026-06-28 时点理解。
