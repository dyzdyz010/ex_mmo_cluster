...
先阅读 docs/docs/20-archive/voxel-authority/2026-05-11-prefab-hot-path-implementation-status.md 和 docs/docs/20-archive/voxel-authority/2026-05-11-next-session-handoff.md。
