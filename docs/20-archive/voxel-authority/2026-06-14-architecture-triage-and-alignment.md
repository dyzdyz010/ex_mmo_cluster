...
> 基线规范:[`docs/30-reference/overview/HEMIFUTURE-MMO-架构设计规范-v2.0.1-冻结稿.md`](../../30-reference/overview/HEMIFUTURE-MMO-架构设计规范-v2.0.1-冻结稿.md)（任务里称 `architecture-v2.0.1.md`，是其简称）。
...
- **2026-06-14(梯队 4 收尾清理告一段落)**：4.1 移除 `WriteTokenStore` 兼容垫片(空 GenServer + 被忽略的
  ...
  [`phase-align-4-cleanup.md`](../infra/phase-align-4-cleanup.md)。**至此对齐迁移梯队 0–4 主体完成:承重契约全部
...
- **2026-06-14(梯队 2 step2.5/2.6:NIF 故障隔离 + 节点级 SimRuntime)**:2.5 移 movement.rs SystemTime
  ...
  NIF-1/5)。详见 [`phase-align-2-nif-fault-and-data-ownership.md`](../infra/phase-align-2-nif-fault-and-data-ownership.md)。
...
- **2026-06-14(梯队 1 收口,step1.6 entity_handoff + cell_migration 正名)**：1.6a 把现有
  ...
  world 149 全绿。详见 [`phase-align-1-step1.6-entity-handoff-cell-migration.md`](../infra/phase-align-1-step1.6-entity-handoff-cell-migration.md)。
...
- **2026-06-14(梯队 1 step1.5b 完成,command_id 跨层线程化,AUTH-4)**：1.5b-1 单方块编辑
  ...
  104 / gate 197 全绿。详见 [`phase-align-1-step1.5b-command-id-threading.md`](../infra/phase-align-1-step1.5b-command-id-threading.md)。
