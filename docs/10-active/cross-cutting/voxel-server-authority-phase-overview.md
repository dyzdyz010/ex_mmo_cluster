...
- **体素同步 · 版本 · 滑动窗口 · 渲染设计（2026-06-29，v2 评审加固)**:[`docs/30-reference/protocol/2026-06-29-voxel-sync-window-and-render-design.md`](../../30-reference/protocol/2026-06-29-voxel-sync-window-and-render-design.md) —— baseline 边界决策的历史下游 HOW 设计稿；其中版本正交、content_version 与动态层边界仍有效，WorldGen 2.5D 内容维度锁定已被纯 3D 立方壳阶段取代。
- **体素生成 / 流送 / Voxia 加载渲染旧实施计划（2026-06-30，已置废)**:[`docs/90-obsolete/voxel-authority/2026-06-30-voxel-generation-streaming-client-plan.md`](../../90-obsolete/voxel-authority/2026-06-30-voxel-generation-streaming-client-plan.md) —— H、H gate、canonical、D/P、checkpoint 等历史术语仍可查；其中客户端本地 WorldGen 派生主路径已被 snapshot-only 投影裁决和完整 3D canonical pages 路线取代。
- **WorldGen v1 确定性地形生成设计（2026-06-30，已置废)**:[`docs/90-obsolete/voxel-authority/2026-06-30-worldgen-v1-deterministic-terrain-design.md`](../../90-obsolete/voxel-authority/2026-06-30-worldgen-v1-deterministic-terrain-design.md) —— 旧 2.5D 算法稿只保留为迁移证据，不再是目标契约；当前目标是 `chunk_xyz -> canonical 3D chunk`，地表只是三维密度算子的一种内容结果。
- **里程碑 A 扩展：完整 3D 体素立方壳与客户端流送（2026-07-12)**:[`2026-07-12-pure-3d-voxel-shell-migration.md`](../voxel-far-field/2026-07-12-pure-3d-voxel-shell-migration.md) —— 当前 Voxia 上位主线。A8/A9 只完成 dev 单 generation 内核；A10 先用客户端 WorldGen 与 H-gated 本地开发包补齐正常入场、同源 near/far、自动 XYZ 滑窗、请求式 page residency、可取消增量 DAG、stable patch、三轴长巡航与材质连续性。本地 request provider 已完成 Pure3D far 首轮；服务器/HTTP/在线 authority 流送后置。当前执行稿见 [`A10 WorldGen 完整客户端 3D 滑动世界`](../voxel-far-field/2026-07-12-a10-cancellable-incremental-voxel-shell-streaming.md)。B/C 均未开始。
- **Voxia VHI 新关卡实验计划（2026-06-30)**:[`docs/90-obsolete/voxel-far-field/2026-06-30-voxia-vhi-experiment-plan.md`](../../90-obsolete/voxel-far-field/2026-06-30-voxia-vhi-experiment-plan.md) —— 在保留旧 `L_WorldGenPreview` 与 heightmap LOD 的前提下，新建 `L_WorldGenVhiPreview` 和 `-VoxiaVhiPreview`，用 Voxel Hierarchical Impostor 试验窗口外三维 visual proxy。
- **Voxia SVO 远景预览设计（2026-06-30)**:[`docs/20-archive/voxel-far-field/2026-06-30-voxia-svo-preview-design.md`](../../20-archive/voxel-far-field/2026-06-30-voxia-svo-preview-design.md) —— 在独立 `L_WorldGenSvoPreview` 关卡中验证 Sparse Voxel Octree macro-cell mesh proxy，目标是窗口边缘连续、约 8km 远景和 120 FPS 预算。
- **Voxia 远景公共组件抽取 + VHI 2.5D baseline（历史）**:[`docs/90-obsolete/voxel-far-field/2026-06-30-voxia-farfield-common-components-and-vhi-baseline.md`](../../90-obsolete/voxel-far-field/2026-06-30-voxia-farfield-common-components-and-vhi-baseline.md) —— 公共组件实现历史仍有效；VHI baseline/二维内容路线已被统一 XYZ near/far 方案取代。
- **Voxia 体素管理管线生产路线（2026-07-05，历史上游）**:[`docs/30-reference/overview/2026-07-05-voxia-voxel-lod-production-route.md`](../../30-reference/overview/2026-07-05-voxia-voxel-lod-production-route.md) —— L0-L3 mesh 主线仍有效；其 L4 raymarch 与旧 A 范围已由下游 v2.7 覆盖。
...
- **Voxia LOD 分层与各层技术选型设计（v2.7)**:[`docs/30-reference/overview/2026-07-06-voxia-lod-layering-and-technology-design.md`](../../30-reference/overview/2026-07-06-voxia-lod-layering-and-technology-design.md) —— 现行三列里程碑：A 扩展为完整 3D LOD 与客户端流送 A1-A10；B 在 A 退出后冻结 1m/7m 生产投影契约；C 才接服务端。raymarch 已退出，L4 只保留需求触发器。
...
| 4-bis | ObjectStateDelta 推送链路 + 客户端碎屑粒子消费 | 已完成 | [`phase-4-bis-object-state-delta-push.md`](../../20-archive/voxel-authority/phase-4-bis-object-state-delta-push.md) |
...
| A1 | 阶段 A 子 2:客户端可玩 demo 必须线(prefab micro / 防覆盖 / 线框预览 / 跳跃同步 / 破坏技能) | 已完成 | [`phase-A1-playable-client-experience.md`](../../20-archive/client/phase-A1-playable-client-experience.md) |
...
| 6 | 局部场最小目标(FieldLayer + 电场 + 温度场 + FieldDebugOverlay) | 已完成 | [`2026-05-13-体素局部场最小目标-索引.md`](../../90-obsolete/field-emergence/2026-05-13-体素局部场最小目标-索引.md) |
...
| Baseline/streaming delta migration | 服务端生产 `base + delta -> snapshot`，客户端只消费 1m/7m snapshot pages；H gate 在进入场景前硬失败 | 原客户端 WorldGen 实施计划已置废；生产投影契约归 B、服务端生产与分发归 C，二者均未开始 | [`2026-06-30-voxel-generation-streaming-client-plan.md`](../../90-obsolete/voxel-authority/2026-06-30-voxel-generation-streaming-client-plan.md) / [`2026-07-06-projection-route-final-decision.md`](../../30-reference/contracts/2026-07-06-projection-route-final-decision.md) |
| Voxia 扩展里程碑 A | 客户端完整 3D near/far LOD、provider-neutral 数据流、原子 presentation 与流送性能 | **A10 实施中**：A6/A7 兼容路径流送与 handoff 已收口；A8/A9 单代内核完成；S1a 已落唯一 `production_all_features` 根，成熟 near 与 Pure3D far 正式同场、自动跟随并通过地面/高空根级 Real-RHI；Pure3D far 的 WorldGen/H-gated local request provider、keep/enter/exit residency、cooperative cancellation、source-bound shared artifact、parallel resolved surface、worker plan、预算化 lease release 与 stable patch transaction 首轮已实跑，相邻 Real-RHI worker 约 `0.91-0.95s`。仍待 near/far 共享 lifecycle/source/coverage generation/transaction、反向依赖/full oracle、离群帧、三轴长巡航与完整材质族；服务器/HTTP/在线 authority provider 后置，B/C 未开始 | [`上位计划`](../voxel-far-field/2026-07-12-pure-3d-voxel-shell-migration.md) / [`WorldGen 客户端滑动世界作战任务`](../voxel-far-field/2026-07-12-a10-cancellable-incremental-voxel-shell-streaming.md) |
| WorldGen v1 旧稿 | 旧 2.5D 高度场算法输入 | **已被纯 3D canonical chunk 契约取代；文档已置废** | [`2026-06-30-worldgen-v1-deterministic-terrain-design.md`](../../90-obsolete/voxel-authority/2026-06-30-worldgen-v1-deterministic-terrain-design.md) |
| Voxia VHI preview | 历史 2.5D 实验 | 已置废；只保留迁移期兼容代码与历史证据 | [`2026-06-30-voxia-vhi-experiment-plan.md`](../../90-obsolete/voxel-far-field/2026-06-30-voxia-vhi-experiment-plan.md) |
| Voxia SVO preview | 新关卡试验 Sparse Voxel Octree macro-cell mesh proxy；目标为无缝、8km 远景、120 FPS 预算 | 设计目标稿 | [`2026-06-30-voxia-svo-preview-design.md`](../../20-archive/voxel-far-field/2026-06-30-voxia-svo-preview-design.md) |
| Voxia FarField 公共组件 + VHI baseline | coverage/build/upload 公共组件历史 | 组件成果继续被兼容路径使用；VHI baseline 结论已被纯 3D 路线取代，文档置废 | [`2026-06-30-voxia-farfield-common-components-and-vhi-baseline.md`](../../90-obsolete/voxel-far-field/2026-06-30-voxia-farfield-common-components-and-vhi-baseline.md) |
...
| Voxia B/C | B=生产投影契约与 fixture oracle；C=服务端 pages/dirty/分发 | **均未开始**；当前不得从 A10 跳转 | [`2026-07-06-voxia-lod-layering-and-technology-design.md`](../../30-reference/overview/2026-07-06-voxia-lod-layering-and-technology-design.md) |
