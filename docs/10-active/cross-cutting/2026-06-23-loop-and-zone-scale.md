...
- 关联:`docs/2026-04-07-增量迁移计划.md` §4(Stage 4 场景分区,7 步设计)、`docs/2026-04-17-场景空间索引架构设计.md`(AOI 瓶颈=N² 交互、SHG+交互管理)、`docs/docs/20-archive/voxel-authority/2026-06-14-architecture-triage-and-alignment.md`(梯队1 分布式正确性前置)、`docs/HEMIFUTURE-MMO-架构设计规范-v2.0.1-冻结稿.md`(FROZEN-5 + EMG 契约)、[[gameplay-roadmap-and-construction-scope]]。
