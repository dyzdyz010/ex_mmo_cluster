...
| [`10-active/`](10-active/README.md) | **活跃工作**（在执行 / 下一步 / 让路待恢复 的决策稿与阶段计划） | 要动手做某主线前先读；新决策稿落这里 | 43 |
| [`20-archive/`](20-archive/README.md) | **已完成·有效历史**（已收口的阶段记录 / 决策 / 诊断） | 追溯"某功能当初怎么做的、为什么" | 122 |
| [`30-reference/`](30-reference/README.md) | **长稳参考**（工程指南 / 线协议 / 术语 / 契约 / 架构概览） | 查规范、契约、协议真值 | 24 |
