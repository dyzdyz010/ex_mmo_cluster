...
# ---- 1. 服务端端口 -----------------------------------------------------------
export AUTH_PORT="${AUTH_PORT:-4000}"          # Phoenix HTTP（auth_server）
export GATE_TCP_PORT="${GATE_TCP_PORT:-29000}" # gate_server TCP（packet:4 分帧）
export GATE_UDP_PORT="${GATE_UDP_PORT:-29001}" # gate_server UDP（movement 快车道）
...
export GAME_WS_URL="${GAME_WS_URL:-ws://127.0.0.1:${AUTH_PORT}/game/ws}"
