defmodule MmoContracts.LiquidFallsWireTest do
  ...
  test "full signed canonical frame and explicit empty clear have frozen little endian bytes" do
    ...
    for {material, transfers, tail} <- [
      {21, [{{-2, -3, 4}, 1}, {{65, 7, -8}, 524288}], <<2, 21::little-16, 2::little-32, -2::little-signed-32, -3::little-signed-32, 4::little-signed-32, 1::little-32, 65::little-signed-32, 7::little-signed-32, -8::little-signed-32, 524288::little-32>>},
    ...
    for invalid <- [<<1, 21::little-16, 0::little-32>>, <<2, 20::little-16, 0::little-32>>, <<2, 21::little-16, 1::little-32>>, <<2, 21::little-16, 1::little-32, 0::96, 0::little-32>>] do
