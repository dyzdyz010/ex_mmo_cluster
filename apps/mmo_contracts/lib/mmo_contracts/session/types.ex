...
defmodule MmoContracts.Session.BodyState do
  @moduledoc "魔法增量 4（Hello 26）：本人身体的推导视图（生命、状态、核心/皮肤温度、伤病）；Hello 29 追加蛋白质储备 protein_g（g）；Hello 30 追加可恢复生命 recoverable（生命条另一色的那一截）。真值在 Scene 的 SceneServer.Body。"
  @enforce_keys [:identity, :life, :recoverable, :status, :core_k, :skin_k, :injuries, :protein_g]
  defstruct @enforce_keys
end
