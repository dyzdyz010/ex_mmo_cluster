defmodule VoxelRegion.ProtectionIdentityTest do
  ...
  defp digest(s) do
    ...
    ledger = Map.drop(s.thermal_accounting, [:elapsed_s, :active])
  ...
  # 电路回路：源（24 V）装在 19 号木头顶面、加热器装在 21 号木头顶面，铜块与回程铜条闭合。
  defp circuit(c, name, _far?) do
    ...
    fed = for {x, tool} <- [{19, 3}, {21, 6}, {19, 8}] do
      seq = next()
  ...
  @recorded %{
    ...
    circuit: %{0.5 => "a3b105d91d8b6f07", 1.0 => "b17448357f2b6d17", 1.5 => "ba65d21b89fd70a1", 2.0 => "9d2bb543eb81fabf", 2.5 => "be286e9285ea49e6", 3.0 => "061086c2bb398f0a", 3.5 => "7a678a02cd210316", 4.0 => "d78c126f2ca4c151", 4.5 => "8d99f612e1b9a21c", 5.0 => "6def1d0cba90bfc8"},
