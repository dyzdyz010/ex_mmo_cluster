defmodule VoxelRegion.OverlayLog do
  ...
  def rows(%{seq: seq, entries: entries, coarse: coarse}=txn) do
    ...
    metadata = Map.take(txn,[:property_states,:epochs,:material_balances,:material_supplies,:phase_inventory,:thermal,:attachment_serial,:attachment_owners,:material_units_per_micro,:liquid_active])
