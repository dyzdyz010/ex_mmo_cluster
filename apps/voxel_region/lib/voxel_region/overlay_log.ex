defmodule VoxelRegion.OverlayLog do
  ...
  def rows(%{seq: seq, entries: entries, coarse: coarse}=txn) do
    ...
    metadata = Map.take(txn,[:property_states,:epochs,:material_balances,:material_supplies,:placed_by,:macro_owners,:protection,:prefab_instances,:phase_inventory,:thermal,:attachment_serial,:attachment_owners,:material_units_per_micro,:liquid_active])
