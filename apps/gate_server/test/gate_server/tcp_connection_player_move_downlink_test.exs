defmodule GateServer.TcpConnectionPlayerMoveDownlinkTest do
  ...
  test "player_move downlink encodes the remote snapshot on tcp fallback", %{
    ...
    assert {:ok,
            <<0x83, 2, 77::64-big, 9::32-big, _server_state_ms::64-big, _server_send_ms::64-big,
              11.0::float-64-big, 12.0::float-64-big, 13.0::float-64-big, 1.0::float-64-big,
              2.0::float-64-big, 3.0::float-64-big, 0.1::float-64-big, 0.2::float-64-big,
              0.3::float-64-big, 0::8>>} =
