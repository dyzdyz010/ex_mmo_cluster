defmodule DataService.Repo.Migrations.CreateVoxelOverlayLog do
  ...
  压实 = 同一事务里删掉该 content_version 全部行、写入检查点事务。`(level, region)` 索引供盒查询。
  """
  ...
  def change do
    ...
    create(index(:voxel_overlay_log, [:content_version, :level, :region_x, :region_y, :region_z], name: :voxel_overlay_log_world_region_index))
  end
end
